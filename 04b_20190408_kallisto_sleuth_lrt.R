...
outf_so  = paste(results_folder, "/04_DEG/sleuth_test07.so", sep="")
outf_deg = paste(results_folder, "/04_DEG/test07.csv", sep="")
outf_counts = paste(results_folder, "/04_DEG/sleuth_matrix_test07.csv", sep="")
